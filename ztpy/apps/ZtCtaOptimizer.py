...
from ztpy.apps.ZtBtAnalyst import summary_analyze
from ztpy.ZtMsgQue import ZtMsgQue,ZtMQServer
...
def start_task_group(env_params, gpName:str, params:list, counter, capital = 5000000, rf = 0, period = 240, 
    ...
    engine = ZtBtEngine(eType=EngineType.ET_CTA, logCfg=content, isFile=False)
    # 配置类型的参数相对固定
