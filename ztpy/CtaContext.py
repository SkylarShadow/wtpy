from ztpy.ProductMgr import ProductInfo
from ztpy.SessionMgr import SessionInfo
from ztpy.ContractMgr import ContractInfo
from ztpy.ZtDataDefs import ZtNpTicks, ZtNpKline
...
class CtaContext:
    ...
    def stra_get_bars(self, stdCode:str, period:str, count:int, isMain:bool = False) -> ZtNpKline:
        '''
        获取历史K线
        @stdCode   合约代码
        @period K线周期, 如m3/d7
