...
class ZtBtSnooper:
    ...
    回测管理器
    '''
    def __init__(self, dtServo:ZtDtServo = None):
        self.path = ""
    ...
    def run_as_server(self, port:int = 8081, host="127.0.0.1", bSync:bool = True):
        ...
        app = FastAPI(title="ZtBtSnooper", description="A simple http api of ZtBtSnooper", openapi_tags=tags_info, redoc_url=None, version="1.0.0")
        app.add_middleware(GZipMiddleware, minimum_size=1000)
        app.add_middleware(SessionMiddleware, secret_key='!@#$%^&*()', max_age=25200, session_cookie='ZtBtSnooper_sid')
