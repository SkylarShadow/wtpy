    ...
    NHnr: function(t, e, s) {
        ...
        var a = s("7+uW"),
            i = {
                name: "App",
                mounted: function() {
                    var t = this.$api.getItem("theme"),
                        e = "";
                    e = "" == t || "black" == t ? "./static/css/style_black.css" : "./static/css/style_white.css", document.getElementById("theme").href = e
                }
            },
            n = {
                render: function() {
        ...
        var o = s("VU/8")(i, n, !1, function(t) { s("juZK") }, null, null).exports,
            l = s("/ocq"),
            r = {
                name: "Login",
                ...
                methods: {
                    doLogin: function() {
                        var t = this,
                            ...
                            s = e.loginid,
                            a = e.passwd;
                        e.loading = !0, this.$api.login(s, a, function(a) {
                            if (a.result < 0) e.$alert("用户登录出错：" + a.message, "登录失败");
                            else {
                                var i = a.userinfo;
                                localStorage.setItem("last_user", s), localStorage.setItem("save_user", e.saveuser ? "true" : "false"), t.$store.commit("loginok", { isLogined: !0, loginid: s, userinfo: i }), e.$router.push("/index")
                            }
                            e.loading = !1
                        })
                    }
            ...
            c = {
                render: function() {
                    var t = this,
                        e = t.$createElement,
                        a = t._self._c || e;
                    return a("div", { directives: [{ name: "loading", rawName: "v-loading", value: t.loading, expression: "loading" }], staticClass: "loginBox" }, [a("div", { staticClass: "login" }, [a("div", { staticClass: "loginForm" }, [a("el-row", { staticClass: "loginLogo" }, [a("h2", [a("img", { attrs: { src: s("Unev"), alt: "" } })])]), t._v(" "), a("div", { staticClass: "login_lab" }, [a("el-row", [a("h1", { staticClass: "login_title" }, [t._v("欢迎登录")])]), t._v(" "), a("el-row", [a("el-input", { staticClass: "textarea t-user", attrs: { placeholder: "用户名" }, model: { value: t.loginid, callback: function(e) { t.loginid = e }, expression: "loginid" } })], 1), t._v(" "), a("el-row", [a("el-input", { staticClass: "textarea t-password", attrs: { placeholder: "密码", type: "password", "show-password": "" }, model: { value: t.passwd, callback: function(e) { t.passwd = e }, expression: "passwd" } })], 1), t._v(" "), a("el-row", [a("el-checkbox", { staticStyle: { float: "right" }, model: { value: t.saveuser, callback: function(e) { t.saveuser = e }, expression: "saveuser" } }, [a("span", { staticStyle: { color: "#9E9E9E" } }, [t._v("保存用户名")])])], 1), t._v(" "), a("el-row", { staticStyle: { "margin-top": "30px" } }, [a("el-button", { staticClass: "zt-btn-login", attrs: { type: "primary", plain: "" }, on: { click: function(e) { return t.doLogin() } } }, [t._v("登 录")])], 1)], 1)], 1)])])
                },
                staticRenderFns: []
            };
        var u = s("VU/8")(r, c, !1, function(t) { s("Jwy3") }, "data-v-726df336", null).exports,
            d = s("Dd8w"),
            f = s.n(d),
            p = s("NYxO"),
            m = {
                name: "index",
                computed: f()({}, Object(p.b)(["cache"]), { isAdmin: function() { var t = this.cache.userinfo; return !!t && ("admin" == t.role || "superman" == t.role) }, isResearcher: function() { var t = this.cache.userinfo; return !!t && "researcher" == t.role } }),
                components: {},
                data: function() { return { showDlgModPwd: !1, oldpwd: "", newpwd: "", confirmpwd: "", loading: !1, notifies: [], lastNotify: null, showNotifies: !1, btValid: !1 } },
                methods: {
                    switchTheme: function() {
                        var t = this.$api.getItem("theme");
                        t = "black" == t ? "white" : "black", this.$api.setItem("theme", t);
                        var e = "";
                        e = "black" == t ? "./static/css/style_black.css" : "./static/css/style_white.css", document.getElementById("theme").href = e
                    },
                    onLogout: function(t) {
                        var e = this;
                    ...
                    handleNotify: function(t) { this.notifies.push(t), this.notifies.length > 100 && (this.notifies = this.notifies.slice(this.notifies.length - 100)), this.lastNotify = t },
                    onClickScroller: function(t) { this.showNotifies = !this.showNotifies },
                    getTitleStyle: function(t) { return "成交回报" == t ? "title-success" : "title-warning" },
                    getIconStyle: function(t) { return "成交回报" == t ? "el-icon-news" : "el-icon-warning-outline" }
                },
                mounted: function() {
                    var t = this;
                    this.cache.isLogined || this.$router.push("/login"), this.$nextTick(function() { t.$api.checkBT(function(e) { e.result < 0 ? t.btValid = !1 : t.btValid = !0 }) })
                }
            },
            g = {
                render: function() {
        ...
        var h = s("VU/8")(m, g, !1, function(t) { s("Bfv8") }, "data-v-29ce220c", null).exports,
            ...
            x = {
                name: "stradata",
                props: { groupid: { type: String, default: function() { return "" } } },
                computed: f()({}, Object(p.b)(["cache"]), { isAdmin: function() { var t = this.cache.userinfo; return !!t && ("admin" == t.role || "superman" == t.role) }, showPos: function() { var t = (this.showPage - 1) * this.pageSize; return this.positions.slice(t, t + this.pageSize) }, showTrd: function() { var t = (this.showPage - 1) * this.pageSize; return this.trades.slice(t, t + this.pageSize) }, showRnd: function() { var t = (this.showPage - 1) * this.pageSize; return this.rounds.slice(t, t + this.pageSize) }, showSig: function() { var t = (this.showPage - 1) * this.pageSize; return this.signals.slice(t, t + this.pageSize) }, showFnd: function() { var t = (this.showPage - 1) * this.pageSize; return this.funds.slice(t, t + this.pageSize) }, dataLength: function() { return "pos" == this.selCat ? this.positions.length : "trd" == this.selCat ? this.trades.length : "sig" == this.selCat ? this.signals.length : "rnd" == this.selCat ? this.rounds.length : "fnd" == this.selCat ? this.funds.length : 0 } }),
                components: {},
                watch: {
                    groupid: function(t, e) {
                        var s = this;
                        t = t || "", e = e || "", 0 != t.length && t != e && setTimeout(function() { s.$api.getStrategies(t, function(t) { t.result < 0 ? s.$notify.error("获取策略列表出错：" + t.message) : (s.strategies = t.strategies, "pos" == s.selCat || "fnd" == s.selCat ? s.strafilter = "all" : "all" == s.strafilter && (s.strafilter = s.strategies[0]), s.showPage = 1, s.queryData()) }) }, 300)
                    }
                },
                data: function() { var t; return t = { showPage: 1, pageSize: 25, pageSizes: [25, 35, 45], selCat: "pos", strafilter: "all", strategies: [], loading: { trade: !1, signal: !1, round: !1, position: !1, fund: !1 }, capital: 5e6, trades: [], positions: [], signals: [], rounds: [] }, b()(t, "strategies", []), b()(t, "funds", []), b()(t, "nvChart", null), b()(t, "autoData", !1), b()(t, "dataInterval", 0), b()(t, "refreshTime", (new Date).format("yyyy.MM.dd hh:mm:ss")), t },
                methods: {
                    onPageSizeChange: function(t) { this.pageSize = t },
                    onPageChange: function(t) { this.showPage = t },
                    handleCheckAutoData: function(t) { this.resetDataInterval() },
                    resetDataInterval: function() {
                        var t = this;
                        this.autoData ? (0 != this.dataInterval && clearInterval(this.dataInterval), this.dataInterval = setInterval(function() { t.queryData() }, 3e4)) : 0 != this.dataInterval && clearInterval(this.dataInterval)
                    },
                    getTrdSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) {
                            if (e < 3 || e > 5) a[e] = "";
                                ...
                                if (4 == e) a[e] = s.length + "笔";
                                else if (5 == e) {
                                    var i = s.map(function(t) { return Number(t.volume) });
                                    i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                }
                            } else a[e] = "本页小计"
                        }), a
                    },
                    getSigSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) { e > 1 ? a[e] = "" : 0 != e ? 1 == e && (a[e] = s.length + "笔") : a[e] = "本页小计" }), a
                    },
                    getPosSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) {
                            if (0 == e || 1 == e || 2 == e || 3 == e)
                                if (0 != e) {
                                    if (1 == e) a[e] = s.length + "笔";
                                    else if (2 == e) {
                                        var i = s.map(function(t) { return Number(t.qty) });
                                        i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + Math.abs(e) }, 0) + "手"
                                    } else if (3 == e) {
                                        var n = s.map(function(t) { return Number(t.profit) });
                                        n.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = n.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(1)
                                    }
                                } else a[e] = "本页小计";
                            else a[e] = ""
                        }), a
                    },
                    getRndSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) {
                    ...
                    queryData: function(t) {
                        ...
                        var s = this,
                            ...
                            i = this.groupid || "",
                            n = this.strafilter || "";
                        0 != i.length ? 0 != n.length ? "trd" == a ? (s.loading.trade = !0, setTimeout(function() { e.$api.getTrades(i, n, function(a) { a.result < 0 ? e.$notify.error("查询成交出错：" + a.message) : (a.trades.forEach(function(t) { var e = ""; "OPEN" == t.offset ? e += "开" : e += "平", "LONG" == t.direction ? e += "多" : e += "空", t.action = e }), s.trades = a.trades, s.trades.reverse()), s.loading.trade = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() }) }, 300)) : "sig" == a ? (s.loading.signal = !0, setTimeout(function() { e.$api.getSignals(i, n, function(a) { a.result < 0 ? e.$notify.error("查询信号出错：" + a.message) : (s.signals = a.signals, s.signals.reverse()), s.loading.signal = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() }) }, 300)) : "rnd" == a ? (s.loading.round = !0, setTimeout(function() { e.$api.getRounds(i, n, function(a) { a.result < 0 ? e.$notify.error("查询回合出错：" + a.message) : (s.rounds = a.rounds, s.rounds.reverse()), s.loading.round = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() }) }, 300)) : "pos" == a ? (s.loading.position = !0, setTimeout(function() { e.$api.getPositions(i, n, function(a) { a.result < 0 ? e.$notify.error("查询持仓出错：" + a.message) : (a.positions.forEach(function(t) { t.qty = t.volume * (t.long ? 1 : -1) }), a.positions.sort(function(t, e) { return t.strategy != e.strategy ? t.strategy - e.strategy : t.code - e.code }), s.positions = a.positions), s.loading.position = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() }) }, 300)) : "fnd" == a && (s.loading.fund = !0, setTimeout(function() {
                            e.$api.getFunds(i, n, function(a) {
                                if (a.result < 0) e.$notify.error("查询绩效出错：" + a.message);
                                else {
                                    if ("all" != n) {
                                        for (var i = null, o = 0; o < a.funds.length; o++) {
                                            var l = a.funds[o];
                                            l.profit = null == i ? l.closeprofit : l.closeprofit - i.closeprofit, l.thisfee = null == i ? l.fee : l.fee - i.fee, l.addition = l.dynbalance - (null == i ? 0 : i.dynbalance), i = l
                                        }
                                        a.funds.reverse()
                                    }
                                    s.funds = a.funds, s.paintChart()
                                }
                                s.loading.fund = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval()
                            })
                        }, 300)) : this.$notify.error("策略ID不能为空") : this.$notify.error("组合ID不能为空")
                    }
                },
                mounted: function() { window.onresize += function() { self.zooming || (self.zooming = !0, setTimeout(function() { self.myChart && self.nvChart.resize(), self.zooming = !1 }, 300)) } }
            },
            M = {
                render: function() {
                    var t = this,
        ...
        var _ = s("VU/8")(x, M, !1, function(t) { s("D8Uw") }, "data-v-70ddc53d", null).exports,
            S = {
                ...
                methods: {
                            ...
                            if (0 == e || 1 == e || 2 == e || 3 == e)
                                if (0 != e) {
                                    if (1 == e) a[e] = s.length + "笔";
                                        ...
                                        var i = s.map(function(t) { return Number(t.long.newvol) }),
                                            n = s.map(function(t) { return Number(t.long.prevol) });
                                        a[e] = "昨" + n.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手 | 今" + i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                    } else if (3 == e) {
                                        var o = s.map(function(t) { return Number(t.short.newvol) }),
                                            l = s.map(function(t) { return Number(t.short.prevol) });
                                        a[e] = "昨" + l.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手 | 今" + o.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                    }
                                } else a[e] = "总计";
                            else a[e] = ""
                        }), a
                        ...
                        return e.forEach(function(t, e) {
                            if (e < 4 || e > 7) a[e] = "";
                                ...
                                if (5 == e) a[e] = s.length + "笔";
                                    ...
                                    var i = s.map(function(t) { return Number(t.total) });
                                    i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                } else if (7 == e) {
                                    var n = s.map(function(t) { return Number(t.traded) });
                                    n.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = n.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                }
                            } else a[e] = "总计"
                        }), a
                    },
                    getFndSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) {
                            if (0 != e) {
                                if (1 == e) a[e] = s.length + "条";
                                else if (2 == e) {
                                    var i = s.map(function(t) { return Number(t.prebalance) });
                                    i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (3 == e) {
                                    var n = s.map(function(t) { return Number(t.balance) });
                                    n.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = n.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (4 == e) {
                                    var o = s.map(function(t) { return Number(t.closeprofit) });
                                    o.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = o.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (5 == e) {
                                    var l = s.map(function(t) { return Number(t.dynprofit) });
                                    l.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = l.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (6 == e) {
                                    var r = s.map(function(t) { return Number(t.margin) });
                                    r.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = r.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (7 == e) {
                                    var c = s.map(function(t) { return Number(t.fee) });
                                    c.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = c.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (8 == e) {
                                    var u = s.map(function(t) { return Number(t.available) });
                                    u.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = u.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                } else if (9 == e) {
                                    var d = s.map(function(t) { return Number(t.moneyio) });
                                    d.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = d.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                }
                            } else a[e] = "总计"
                        }), a
                    },
                    ...
                    getActClr: function(t) { return "开多" == t || "平空" == t || "平今空" == t ? "text-danger" : "text-success" },
                    handleCatChange: function(t, e) {
                        if (this.selCat != t.name) {
                            this.selCat = t.name;
                            var s = this.showAllChannels(this.selCat);
                            s || "all" != this.chnlfilter ? s && (this.chnlfilter = "all") : this.chnlfilter = this.channels[0], this.showPage = 1, this.queryData()
                        }
                    },
                    onChnlSwitch: function() { this.showPage = 1, this.queryData() },
                    formatTime: function(t, e) {
                        var s = t[e.property],
                            a = new Date;
                        return a.setTime(s), a.format("yyyy/MM/dd hh:mm:ss")
                    },
                    fmtPrice: function(t, e) { for (var s = t[e.property].toFixed(4), a = 0; a < s.length && "0" == s[s.length - 1 - a]; a++); "." == s[s.length - 1 - a] && a++; var i = s.length - a; return s.substr(0, i) },
                    fmtAmount: function(t, e) { return t[e.property].toFixed(2) },
                    queryData: function(t) {
                        var e = this;
                        t = t || !1;
                        var s = this,
                            ...
                            i = this.groupid || "",
                            n = this.chnlfilter || "";
                        0 != i.length ? 0 != n.length ? "trd" == a ? (s.loading.trade = !0, setTimeout(function() {
                            e.$api.getChnlTrades(i, n, function(a) {
                                a.result < 0 ? e.$notify.error("查询成交出错：" + a.message) : (a.trades.forEach(function(t) {
                                    var e;
                                    t.action = "OL" == (e = t.action) ? "开多" : "OS" == e ? "开空" : "CL" == e ? "平多" : "CS" == e ? "平空" : "CNL" == e ? "平今多" : "CNS" == e ? "平今空" : "CPL" == e ? "平昨多" : "CPS" == e ? "平昨空" : e
                                }), s.trades = a.trades, s.trades.reverse()), s.loading.trade = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval()
                            })
                        }, 300)) : "ord" == a ? (s.loading.order = !0, setTimeout(function() {
                            e.$api.getChnlOrders(i, n, function(a) {
                                a.result < 0 ? e.$notify.error("查询订单出错：" + a.message) : (a.orders.forEach(function(t) {
                                    var e;
                                    t.action = "OL" == (e = t.action) ? "开多" : "OS" == e ? "开空" : "CL" == e ? "平多" : "CS" == e ? "平空" : "CNL" == e ? "平今多" : "CNS" == e ? "平今空" : "CPL" == e ? "平昨多" : "CPS" == e ? "平昨空" : e
                                }), s.orders = a.orders, s.orders.reverse()), s.loading.order = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval()
                            })
                        }, 300)) : "pos" == a ? (s.loading.position = !0, setTimeout(function() {
                            e.$api.getChnlPositions(i, n, function(a) {
                                if (a.result < 0) e.$notify.error("查询持仓出错：" + a.message);
                                else {
                                    var i = [];
                                    a.positions.forEach(function(t) { t.long.newvol + t.long.prevol + t.short.newvol + t.short.prevol != 0 && i.push(t) }), e.positions = i
                                }
                                s.loading.position = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval()
                            })
                        }, 300)) : "fnd" == a && (s.loading.fund = !0, setTimeout(function() {
                            e.$api.getChnlFunds(i, n, function(a) {
                                if (a.result < 0) e.$notify.error("查询资金出错：" + a.message);
                                else {
                                    var i = [];
                                    for (var n in a.funds) {
                                        var o = a.funds[n];
                                        for (var l in o) {
                                            var r = o[l];
                                            r.channel = n, r.currency = l, r.moneyio = r.deposit - r.withdraw, r.dynprofit = r.dynprofit || 0, i.push(r)
                                        }
                                    }
                                    s.funds = i
                                }
                        ...
                        }, 300)) : this.$notify.error("通道ID不能为空") : this.$notify.error("组合ID不能为空")
                    }
                }
            },
            L = {
        ...
        var C = s("VU/8")(S, L, !1, function(t) { s("tV8Q") }, "data-v-f3d95bac", null).exports,
            N = {
                ...
                methods: {
                    ...
                    getTrdSum: function(t) {
                        ...
                        return e.forEach(function(t, e) {
                            if (e < 2) a[e] = "";
                                ...
                                if (3 == e) a[e] = s.length + "笔";
                                else if (4 == e) {
                                    var i = s.map(function(t) { return Number(t.volume) });
                                    i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0) + "手"
                                } else if (5 == e) {
                                    var n = s.map(function(t) { return Number(t.fee) });
                                    n.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = n.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + e }, 0).toFixed(2)
                                }
                            } else a[e] = "本页小计"
                        }), a
                    ...
                    resetDataInterval: function() {
                        var t = this;
                        this.autoData ? (0 != this.dataInterval && clearInterval(this.dataInterval), this.dataInterval = setInterval(function() { "pos" == t.selCat && t.queryData() }, 3e4)) : 0 != this.dataInterval && clearInterval(this.dataInterval)
                    },
                    getPosSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                        ...
                        return e.forEach(function(t, e) {
                            if (0 == e || 1 == e || 2 == e || 3 == e)
                                if (0 != e) {
                                    if (1 == e) s.map(function(t) { return Number(t.qty) }).every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = s.length + "笔";
                                    else if (2 == e) {
                                        var i = s.map(function(t) { return Number(t.qty) });
                                        i.every(function(t) { return isNaN(t) }) ? a[e] = "N/A" : a[e] = i.reduce(function(t, e) { var s = Number(e); return isNaN(s) ? t : t + Math.abs(e) }, 0) + "手"
                                    } else if (3 == e) {
                    ...
                    handleCatChange: function(t, e) { this.selCat != t.name && (this.selCat = t.name, this.showPage = 1, this.queryData()) },
                    formatAmount: function(t, e) { return t[e.property].toFixed(2) },
                    fmtFundTime: function(t) { var e = Math.floor(t / 1e3) + ""; return e.length < 6 && (e = "0" + e), e.substr(0, 2) + ":" + e.substr(2, 2) },
                    fmtFundDate: function(t) { var e = t + ""; return e.substr(2, 2) + "." + e.substr(4, 2) + "." + e.substr(6, 2) },
                    fmtPrice: function(t) { for (var e = t.toFixed(4), s = 0; s < e.length && "0" == e[e.length - 1 - s]; s++); "." == e[e.length - 1 - s] && s++; var a = e.length - s; return e.substr(0, a) },
                    fmtTime: function(t, e) { if (e = e || !1) { var s = t + ""; return s.substr(2, 2) + "." + s.substr(4, 2) + "." + s.substr(6, 2) + " " + s.substr(8, 2) + ":" + s.substr(10, 2) + ":" + s.substr(12, 2) + "," + s.substr(14, 3) } var a = t + ""; return a.substr(2, 2) + "." + a.substr(4, 2) + "." + a.substr(6, 2) + " " + a.substr(8, 2) + ":" + a.substr(10, 2) },
                    fmtDate: function(t) { var e = t + ""; return e.substr(0, 4) + "." + e.substr(4, 2) + "." + e.substr(6, 2) },
                    fmtProfit: function(t) { return t > 0 ? "text-danger" : t < 0 ? "text-success" : "" },
                    onClickResetCapital: function() {
                        var t = parseInt(this.capital);
                        this.funds.forEach(function(e) { e.capital = t }), this.paintChart()
                    },
                    paintChart: function() {
                    ...
                    paintBars: function() {
                        if (this.isAdmin) {
                            null == this.pieChart && (this.pieChart = this.$echarts.init(document.getElementById("pie")));
                            var t = [],
                                e = [];
                            for (var s in this.performances) {
                                var a = this.performances[s],
                                    i = a.closeprofit + a.dynprofit;
                                t.push({ name: s, value: i, itemStyle: { color: i > 0 ? "#C23531" : "#228B22" } })
                            }
                            t.sort(function(t, e) { return t.name.localeCompare(e.name) }), t.forEach(function(t) { e.push(t.name) });
                            var n = { title: { text: "组合绩效归因", textStyle: { color: "#E4E4E4", fontSize: "14" }, subtext: "按品种", left: "center" }, grid: { left: "13%", right: "3%", bottom: "13%" }, xAxis: { type: "category", data: e, axisLine: { lineStyle: { color: "#1B212E" } }, axisLabel: { textStyle: { color: "#B4B4B5", fontSize: 9 } } }, yAxis: { type: "value", axisLine: { lineStyle: { color: "#1B212E" } }, axisLabel: { textStyle: { color: "#B4B4B5", fontSize: 9 } }, splitLine: { lineStyle: { color: "#1B212E" } } }, legend: { show: !1 }, tooltip: { trigger: "item", formatter: function(t) { return t.name + ": " + (t.value / 1e4).toFixed(2) + "万" } }, series: [{ name: "分品种绩效", type: "bar", data: t }] };
                    ...
                    checkAllFilters: function(t, e) { for (var s in this.filters[t]) this.filters[t][s] = e },
                    ...
                    queryRtFund: function() {
                        var t = this,
                            e = this.groupid || "",
                            s = this,
                            a = parseInt(s.capital);
                        this.$api.getPortFunds(e, function(e) {
                            if (e.result < 0) t.$notify.error("查询绩效出错：" + e.message);
                                ...
                                var i = null,
                                    n = 0,
                                    o = 0;
                                e.funds.forEach(function(t) { t.dynbalance = t.balance + t.dynprofit, t.capital = a, t.profit = t.closeprofit + t.dynprofit - (null == i ? 0 : i.dynprofit) - t.fee, o += t.closeprofit, n += t.fee, t.totalfee = n, t.totalprofit = o, i = t }), e.funds.length > 0 && (s.rtFund = e.funds[e.funds.length - 1])
                            }
                        })
                    },
                    queryData: function(t) {
                        ...
                        var s = this,
                            a = this.selCat,
                            i = this.groupid || "";
                        0 != i.length ? "pos" == a ? (s.loading.position = !0, setTimeout(function() { e.$api.getPortPositions(i, function(a) { a.result < 0 ? e.$notify.error("查询持仓出错：" + a.message) : (a.positions.forEach(function(t) { t.qty = t.volume * (t.long ? 1 : -1) }), s.positions = a.positions.sort(function(t, e) { return t.code.localeCompare(e.code) })), s.loading.position = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() }), e.queryPerf(), e.queryRtFund() }, 300)) : "fnd" == a ? (s.loading.fund = !0, setTimeout(function() {
                            var a = parseInt(s.capital);
                            e.$api.getPortFunds(i, function(i) {
                                if (i.result < 0) e.$notify.error("查询绩效出错：" + i.message);
                                else {
                                    var n = null,
                                        o = 0,
                                        l = 0;
                                    i.funds.forEach(function(t) { t.dynbalance = t.balance + t.dynprofit, t.capital = a, t.profit = t.closeprofit + t.dynprofit - (null == n ? 0 : n.dynprofit) - t.fee, l += t.closeprofit, o += t.fee, t.totalfee = o, t.totalprofit = l, n = t }), s.funds = i.funds, s.funds.reverse(), s.paintChart()
                                }
                                s.loading.fund = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval()
                            })
                        }, 300)) : "rsk" == a ? (s.loading.risk = !0, setTimeout(function() {
                            parseInt(s.capital);
                            e.$api.getPortFilters(i, function(a) { a.result < 0 ? e.$notify.error("查询过滤器出错：" + a.message) : (a.filters.strategy_filters = a.filters.strategy_filters || {}, a.filters.code_filters = a.filters.code_filters || {}, a.filters.channel_filters = a.filters.executer_filters || {}, s.filters = a.filters), s.loading.risk = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() })
                        }, 300)) : "trd" == a ? (s.loading.trade = !0, setTimeout(function() {
                            parseInt(s.capital);
                            e.$api.getPortTrades(i, function(a) { a.result < 0 ? e.$notify.error("查询成交出错：" + a.message) : (a.trades.forEach(function(t) { var e = ""; "OPEN" == t.offset ? e += "开" : e += "平", "LONG" == t.direction ? e += "多" : e += "空", t.action = e }), s.trades = a.trades, s.trades.reverse()), s.loading.trade = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() })
                        }, 300)) : "rnd" == a && (s.loading.round = !0, setTimeout(function() {
                            parseInt(s.capital);
                            e.$api.getPortRounds(i, function(a) { a.result < 0 ? e.$notify.error("查询回合出错：" + a.message) : (s.rounds = a.rounds, s.rounds.reverse()), s.loading.round = !1, s.refreshTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), t && s.resetDataInterval() })
                        }, 300)) : this.$notify.error("组合ID不能为空")
                    }
                },
                mounted: function() {
                    var t = this;
                    window.onresize = function() { t.zooming || (t.zooming = !0, setTimeout(function() { t.myChart && t.nvChart.resize(), t.pieChart && t.pieChart.resize(), t.zooming = !1 }, 300)) }, t.$nextTick(function() { t.$on("resize", function() { t.zooming || (t.zooming = !0, setTimeout(function() { t.myChart && t.nvChart.resize(), t.pieChart && t.pieChart.resize(), t.zooming = !1 }, 150)) }) })
                }
            },
            k = {
                render: function() {
            ...
            I = {
                render: function() {
                    var t = this,
                        e = t.$createElement,
                        s = t._self._c || e;
                    return s("div", { staticClass: "bord39", staticStyle: { height: "99%", width: "100%", display: "flex", "flex-direction": "row", padding: "2px" } }, [s("div", { staticStyle: { flex: "0 320px", "min-width": "320px", margin: "4px" } }, [s("div", { staticClass: "bord39", staticStyle: { height: "98%", overflow: "auto", "border-radius": "2px" } }, [s("el-tree", { staticStyle: { "background-color": "transparent", color: "#97979E" }, attrs: { data: t.folders }, on: { "node-click": t.handleFileClick } })], 1)]), t._v(" "), s("div", { staticStyle: { flex: "1", margin: "4px", display: "flex", "flex-direction": "column", overflow: "auto" } }, [s("div", { directives: [{ name: "loading", rawName: "v-loading", value: t.fileOnway, expression: "fileOnway" }], staticClass: "bord39", staticStyle: { flex: "1 0 auto", height: "0", width: "100%", overflow: "auto", "border-radius": "2px" } }, [s("codemirror", { ref: "mycode", staticStyle: { height: "100%" }, attrs: { options: t.cmOptions }, model: { value: t.content_s, callback: function(e) { t.content_s = e }, expression: "content_s" } })], 1), t._v(" "), s("div", { staticStyle: { flex: "0 36px", "margin-top": "4px" } }, [s("span", { staticStyle: { "font-size": "12px", color: "gray", float: "left" } }, [t._v("当前文件:" + t._s(t.curFilePath))]), t._v(" "), s("el-button", { directives: [{ name: "show", rawName: "v-show", value: !t.edit, expression: "!edit" }], staticClass: "zt-btn-Refresh", staticStyle: { float: "right" }, attrs: { size: "mini" }, on: { click: function(e) { return t.onClickEdit() } } }, [s("i", { staticClass: "el-icon-edit" }), t._v("修改\n            ")]), t._v(" "), s("el-button", { directives: [{ name: "show", rawName: "v-show", value: t.edit, expression: "edit" }], staticClass: "zt-btn-Refresh", staticStyle: { float: "right" }, attrs: { size: "mini" }, on: { click: function(e) { return t.onClickCommit() } } }, [s("i", { staticClass: "el-icon-set-up" }), t._v("提交\n            ")]), t._v(" "), s("el-button", { directives: [{ name: "show", rawName: "v-show", value: t.edit, expression: "edit" }], staticClass: "zt-btn-Cancel", staticStyle: { float: "right" }, attrs: { size: "mini" }, on: { click: function(e) { return t.onClickCancel() } } }, [s("i", { staticClass: "el-icon-refresh-left" }), t._v("取消\n            ")])], 1)])])
                },
                staticRenderFns: []
            };
        var z = {
                name: "empty",
                components: { StrategyData: _, ChannelData: C, PorfolioData: D, Editor: s("VU/8")(T, I, !1, function(t) { s("duJY"), s("w7/U") }, "data-v-d1a89864", null).exports },
                computed: f()({}, Object(p.b)(["cache"]), { isAdmin: function() { var t = this.cache.userinfo; return !!t && ("admin" == t.role || "superman" == t.role) }, groupid: function() { return null == this.groupinfo ? "" : this.groupinfo.id } }),
                props: { groupinfo: { type: Object, default: function() { return { id: "", name: "", path: "", info: "", gtype: "cta", datmod: "auto" } } } },
                watch: {
                    groupinfo: function(t, e) {
                        var s = this;
                        null != t && (null != e && t.id == e.id || (this.logScroll = "auto" == t.datmod, setTimeout(function() { s.queryLogs(!0) }, 300)))
                    }
                },
                data: function() { return { selData: "sdata", logs: "", logfilter: "total", logCache: "", logLines: 0, logScroll: !0, logOnway: !1, autoLog: !1, logInterval: 0, logTime: (new Date).format("yyyy.MM.dd hh:mm:ss") } },
                methods: {
                    handleClickTab: function(t, e) {
                        var s = this;
                        this.selData = t.name, "pdata" == t.name && setTimeout(function() { s.$refs.portfolio.$emit("resize") }, 150)
                    },
                    handleClickQryLog: function() {
                        var t = this;
                        setTimeout(function() { t.queryLogs(!0) }, 300)
                    },
                    handleCheckAutoLog: function(t) { this.resetLogInterval() },
                    resetLogInterval: function() {
                        var t = this;
                        this.autoLog ? (0 != this.logInterval && clearInterval(this.logInterval), this.logInterval = setInterval(function() { t.queryLogs() }, 15e3)) : 0 != this.logInterval && clearInterval(this.logInterval)
                    },
                    queryLogs: function(t) {
                        var e = this;
                        t = t || !1;
                        var s = this;
                        "" != this.groupinfo.id && (s.logOnway = !0, this.$api.getLogs(this.groupinfo.id, this.logfilter, function(a) {
                            a.result < 0 ? (e.logs = "", e.logLines = 0, e.$notify.error("组合日志拉取失败：" + a.message), s.$nextTick(function() { s.$refs.logs.scrollTo(0, 0) })) : (e.logs = a.content, e.logLines = a.lines || 0, s.$nextTick(function() {
                                var t = s.$refs.logs.scrollHeight;
                                s.$refs.logs.scrollTo(0, t)
                            })), s.logTime = (new Date).format("yyyy.MM.dd hh:mm:ss"), s.logOnway = !1, t && s.resetLogInterval()
                        }))
                    },
                    processLog: function(t) {
                        var e = this,
                            s = t.message || "";
                        if (s.length > 0) {
                            var a = 0 == e.logCache.length,
                                i = "[" + new Date(t.time).format("yyyy.MM.dd hh:mm:ss") + " - " + t.tag + " ] " + s + "\n";
                            e.logCache += i, e.logLines++, a && e.$nextTick(function() {
                                e.logLines >= 200 && (e.logs = "", e.logLines = 0), e.logs += e.logCache, e.logCache = "", e.$nextTick(function() {
                                    var t = e.$refs.logs.scrollHeight;
                                    e.$refs.logs.scrollTo(0, t)
                                })
                            })
                        }
                    },
                    processEvent: function(t) {
                        var e = t.evttype || "";
                        if ("" != e)
                            if ("notify" == e) this.$message({ title: "订单回报", type: "error", message: "交易通道{0}错误：{1}".format(t.channel, t.data), duration: 0, showClose: !0 });
                            else if ("order" == e) {
                            if (!t.data.canceled) return;
                            this.$notify({ title: "订单回报", type: "error", message: "交易通道{0}订单已撤销，本地订单号：{1}".format(t.channel, t.data.localid) })
                        } else if ("trade" == e) {
                            var s = (t.data.isopen ? "开" : "平") + (t.data.islong ? "多" : "空");
                            this.$notify({ title: "成交回报", type: "success", message: "交易通道：{0}，操作：{1}，代码：{2}，数量：{3}，成交价：{4}，本地订单号：{5}".format(t.channel, s, t.data.code, t.data.volume, t.data.price, t.data.localid) })
                        }
                    }
                },
                mounted: function() {
                    var t = this;
                    t.$on("notify", function(e) {
                        if (e.groupid == t.groupinfo.id)
                            if ("gplog" == e.type) {
                                if (!t.logScroll) return;
                                t.processLog(e)
                            } else "chnlevt" == e.type && t.processEvent(e)
                    })
                }
            },
            A = {
        ...
        var E = s("VU/8")(z, A, !1, function(t) { s("1lGd") }, "data-v-45a3c652", null).exports,
            O = {
                ...
                staticRenderFns: [function() {
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("div", { staticClass: "empty-box" }, [e("div", { staticClass: "content" }, [e("h2", [this._v("尚未添加组合")])])])
                }]
            };
        var F = s("VU/8")({ name: "empty", components: {}, data: function() { return {} }, methods: {} }, O, !1, function(t) { s("cNKU") }, "data-v-a9c83ba8", null).exports,
            $ = {
                name: "schedule",
                computed: f()({}, Object(p.b)(["folders"])),
                props: { fixinfo: { type: Boolean, default: function() { return !1 } }, forapp: { type: Boolean, default: function() { return !1 } }, config: { type: Object, default: function() { return { id: "", folder: "", path: "", param: "", mqurl: "", span: 3, guard: !1, redirect: !1, schedule: { active: !0, weekflag: "0111110", weekmask: [!1, !0, !0, !0, !0, !0, !1], tasks: [{ active: !1, time: "00:00", action: 0 }, { active: !1, time: "00:00", action: 0 }, { active: !1, time: "00:00", action: 0 }, { active: !1, time: "00:00", action: 0 }, { active: !1, time: "00:00", action: 0 }, { active: !1, time: "00:00", action: 0 }] } } } } },
                data: function() { return { showfolders: !1, selfolder: "", actions: ["启动", "停止", "重启"] } },
                methods: {
                    onLinkPython: function() {
                        var t = this;
                        this.$api.getPythonPath(function(e) { e.result < 0 ? t.$alert(e.message) : t.config.path = e.path })
                    },
                    handlePickFolder: function(t) {
                        var e = this,
                            s = this;
                        s.selfolder = "", 0 == s.folders.length ? this.$api.getFolders(function(t) { t.result < 0 ? s.$alert(t.message) : (e.$store.commit("setfolders", { folders: [t.tree] }), s.showfolders = !0) }) : s.showfolders = !0
                    },
                    handleFolderPicked: function() { "" == this.selfolder ? this.$alert("请选择目录") : (this.config.folder = this.selfolder, this.showfolders = !1) },
                    handleFolderClick: function(t) { this.selfolder = t.path },
                    onConfigCommit: function() {
                        var t = this,
                            e = JSON.parse(w()(this.config));
                        if (0 != e.path.length)
                            if (0 != e.id.length)
                                if (0 != e.folder.length) {
                                    e.schedule.weekflag = "";
                                    for (var s = 0; s < 7; s++) e.schedule.weekflag += e.schedule.weekmask[s] ? "1" : "0";
                                    for (var a = 0; a < 6; a++) {
                                        var i = e.schedule.tasks[a].time;
                                        i = i.replace(":", ""), e.schedule.tasks[a].time = parseInt(i)
                                    }
                                    e.redirect = !this.forapp, e.isapp = this.forapp, this.$confirm("确定要提交该调度配置?", "自动调度", { confirmButtonText: "确定", cancelButtonText: "取消", type: "warning" }).then(function() { delete e.schedule.weekmask, t.$api.commitMonCfg({ config: e }, function(e) { e.result < 0 ? t.$message.error(e.message) : (t.$message({ message: "监控配置已提交成功", type: "success" }), t.$emit("cfgudt")) }) })
                                } else this.$alert("执行目录不能为空");
                        else this.$alert("应用ID不能为空");
                        else this.$alert("执行程序路径不能为空")
                    }
                }
            },
            U = {
                ...
                methods: {
                    ...
                    onCommitGroup: function() {
                        var t = this,
                            e = this,
                            s = this.copyGroup;
                        this.$api.commitGroup(s, this.addGroup ? "add" : "mod", function(a) { a.result < 0 ? e.$notify.error("提交组合信息失败：" + a.message) : (t.addGroup && e.groups.push(s), e.showgrpdlg = !1, null == e.curGroup && (e.curGroup = s)) })
                    },
                    onCloseGrpDlg: function(t) { t() },
                    handleViewGroup: function(t) { null != t && (this.copyGroup = JSON.parse(w()(t)), this.copyGroup.datmod = this.copyGroup.datmod || "mannual", this.addGroup = !1, this.editGroup = !1, this.showgrpdlg = !0) },
                    handleStartGroup: function(t) {
                        var e = this;
                        if (null != t && "" != t.id)
                            if (t.running) this.$notify("组合正在运行");
                            else {
                                var s = this,
                                    a = t.id;
                                s.monitors[a] ? this.$api.startGroup(t.id, function(t) { t.result < 0 && e.$notify.error("启动组合失败：" + t.message) }) : s.$api.getMonCfg(a, function(i) {
                                    if (i.result < 0) s.$notify.error(i.message);
                                    else if (i.config) {
                                        var n = i.config;
                                        n.schedule.weekmask = [];
                                        ...
                                        s.monitors[a] = n, e.$api.startGroup(t.id, function(t) { t.result < 0 && e.$notify.error(t.message) })
                                    } else s.$alert("该组合尚未配置调度，不能启动")
                                })
                            }
                    },
                    handleStopGroup: function(t) {
                        var e = this;
                        null != t && "" != t.id && (t.running ? this.$confirm("确定要停止该组合吗?", "手动停止", { confirmButtonText: "确定", cancelButtonText: "取消", type: "warning" }).then(function() { e.$api.stopGroup(t.id, function(t) { t.result < 0 && e.$notify.error(t.message) }) }) : this.$notify("组合已经处于停止状态"))
                    },
                    refreshAllGrpFunds: function() {
                        for (var t = this, e = this, s = function(s) {
                                var a = t.groups[s].id,
                                    i = t.groups[s];
                                e.$api.getPortFunds(a, function(t) {
                                    if (t.result < 0) e.$notify.error("查询绩效出错：" + t.message);
                                    else {
                                        var s = null,
                                            a = 0,
                                            n = 0;
                                        t.funds.forEach(function(t) { t.dynbalance = t.balance + t.dynprofit, t.profit = t.closeprofit + t.dynprofit - (null == s ? 0 : s.dynprofit) - t.fee, n += t.closeprofit, a += t.fee, t.totalfee = a, t.totalprofit = n, s = t }), t.funds.length > 0 ? i.lastFund = t.funds[t.funds.length - 1] : i.lastFund = null
                                    }
                                })
                            }, a = 0; a < this.groups.length; a++) s(a)
                    }
                },
                mounted: function() {
                    var t = this,
                        e = this;
                    setTimeout(function() {
                        e.$api.getGroups(function(s) {
                            s.result < 0 ? e.$notify.error("查询组合出错：" + s.message) : function() {
                                s.groups.sort(function(t, e) { return t.name.localeCompare(e.name) });
                                for (var a = s.groups, i = e.capital, n = function(t) {
                                        var s = a[t].id,
                                            n = a[t];
                                        e.$api.getPortFunds(s, function(t) {
                                            if (t.result < 0) e.$notify.error("查询绩效出错：" + t.message);
                                            else {
                                                var s = null,
                                                    a = 0,
                                                    o = 0;
                                                t.funds.forEach(function(t) { t.dynbalance = t.balance + t.dynprofit, t.capital = i, t.profit = t.closeprofit + t.dynprofit - (null == s ? 0 : s.dynprofit) - t.fee, o += t.closeprofit, a += t.fee, t.totalfee = a, t.totalprofit = o, s = t }), t.funds.length > 0 ? n.lastFund = t.funds[t.funds.length - 1] : n.lastFund = null
                                            }
                                        })
                                    }, o = 0; o < a.length; o++) n(o);
                                setTimeout(function() { e.groups = a, e.groups.length > 0 && (e.selectedIdx = e.groups[0].id, e.curGroup = e.groups[0]), t.$store.commit("setgroups", { groups: a }), e.$pusher.on("connect", function(t) { console.log("ws连接成功"), e.curGroup && e.$pusher.subscribe(e.curGroup.id), console.log("subscribe to " + e.curGroup.id) }) }, 500), e.$pusher.on("message", function(t) {
                                    if ("gpevt" == t.type && ("start" == t.evttype ? setTimeout(function() { e.$notify({ message: "组合" + t.groupid + "已启动", type: "success" }) }, 300) : "stop" == t.evttype && setTimeout(function() { e.$notify.error("组合" + t.groupid + "已停止") }, 300)), "chnlevt" == t.type) {
                                        var s = null,
                                            a = t.evttype || "",
                                            i = null;
                                        if (e.groups.forEach(function(e) { e.id == t.groupid && (i = e) }), null != i) {
                                            if ("notify" == a) s = { time: new Date, group: i.name, channel: t.channel, title: "事件通知", type: "error", message: "错误：{1}".format(t.channel, t.data) };
                                            else if ("order" == a) t.data.canceled && (s = { time: new Date, group: i.name, channel: t.channel, title: "订单回报", type: "danger", message: "订单已撤销，本地订单号：{1}".format(t.channel, t.data.localid) });
                                            else if ("trade" == a) {
                                                var n = (t.data.isopen ? "开" : "平") + (t.data.islong ? "多" : "空");
                                                s = { time: new Date, group: i.name, channel: t.channel, title: "成交回报", type: "success", message: "操作：{1}，代码：{2}，数量：{3}，成交价：{4}，本地订单号：{5}".format(t.channel, n, t.data.code, t.data.volume, t.data.price, t.data.localid) }
                                            }
                                            null != s && e.$emit("notify", s)
                                        }
                                    }
                                    null != e.curGroup && t.groupid == e.curGroup.id && ("gplog" == t.type || "chnlevt" == t.type ? e.$refs.group && e.$refs.group.$emit("notify", t) : "gpevt" == t.type && ("start" == t.evttype ? e.curGroup.running = !0 : "stop" == t.evttype && (e.curGroup.running = !1)))
                                }), e.$pusher.init("ws://" + window.location.host, ["auth", "trade", "order", "notify"])
                            }()
                        })
                    }, 300)
                }
        ...
        var Q = s("VU/8")(Y, P, !1, function(t) { s("0/Yr") }, "data-v-7239c96b", null).exports,
            B = {
                ...
                staticRenderFns: [function() {
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("div", { staticClass: "loginBox" }, [e("div", { staticClass: "login" }, [this._v("\n        在线部署功能建设中，敬请期待\n    ")])])
                }]
            };
        var W = s("VU/8")({ name: "Deploy", data: function() { return {} }, methods: {}, mounted: function() {} }, B, !1, function(t) { s("DoUX") }, "data-v-0cbbd64e", null).exports,
            q = (s("jQeI"), s("CK2l"), s("c+I8"), s("iHuw"), s("RkhK"), s("LxZp"), {
                name: "BTComp",
                props: { btInfo: { type: Object, default: function() { return null } }, straInfo: { type: Object, default: function() { return null } } },
                watch: {
                    btInfo: function(t, e) {
                        var s = this;
                        null != t && (null != e && t.id == e.id || setTimeout(function() { s.queryTrades(), s.queryRounds(), s.queryFunds(), s.querySignals() }, 300))
                    }
                },
                data: function() { return { loading: { signal: !1, round: !1, fund: !1, trade: !1 }, selCat: "summary", signals: [], rounds: [], funds: [], trades: [], kChart: null, tChart: null, bars: [] } },
                methods: {
                    fmtBtTime: function(t) { return (t += "").substr(0, 4) + "." + t.substr(4, 2) + "." + t.substr(6, 2) + " " + t.substr(8, 2) + ":" + t.substr(10, 2) },
                    onCatSel: function(t, e) {
                        var s = this;
                        this.selCat != t.name && (this.selCat = t.name, "kline" == t.name && this.kChart ? setTimeout(function() { s.kChart.resize() }, 300) : "summary" == t.name && this.tChart && setTimeout(function() { s.tChart.resize() }, 300))
                    },
                    queryBars: function() {
                        var t = this;
                        if (null != this.btInfo) {
                            var e = this.btInfo.state.code,
                                s = this.btInfo.state.stime,
                                a = this.btInfo.state.etime,
                                i = this.btInfo.state.period;
                            this.$api.getBtBars(e, i, s, a, function(e) { e.result < 0 ? t.$notify.error("拉取K线出错：" + e.message) : (t.bars = e.bars, t.paintChart(!1)) })
                        }
                    },
                    querySignals: function() {
                        var t = this,
                            e = this.straInfo.id,
                            s = this.btInfo.id;
                        this.loading.signal = !0, this.$api.getBtSignals(e, s, function(e) { e.result < 0 ? t.$notify.error("查询信号出错：" + e.message) : (t.signals = e.signals, t.signals.reverse()), t.loading.signal = !1 })
                    },
                    queryTrades: function() {
                        var t = this,
                            e = this.straInfo.id,
                            s = this.btInfo.id;
                        this.loading.trade = !0, this.$api.getBtTrades(e, s, function(e) { e.result < 0 ? t.$notify.error("查询成交出错：" + e.message) : (e.trades.forEach(function(t) { var e = ""; "OPEN" == t.offset ? e += "开" : e += "平", "LONG" == t.direction ? e += "多" : e += "空", t.action = e }), t.trades = e.trades, t.trades.reverse()), t.loading.trade = !1, setTimeout(function() { t.queryBars() }, 300) })
                    },
                    queryRounds: function() {
                        var t = this,
                            e = this.straInfo.id,
                            s = this.btInfo.id;
                        this.loading.round = !1, this.$api.getBtRounds(e, s, function(e) { e.result < 0 ? t.$notify.error("查询回合出错：" + e.message) : (t.rounds = e.rounds, t.rounds.reverse()), t.loading.round = !1 })
                    },
                    queryFunds: function() {
                        var t = this,
                            e = this.straInfo.id,
                            s = this.btInfo.id;
                        this.loading.fund = !0, this.$api.getBtFunds(e, s, function(e) { e.result < 0 ? t.$notify.error("查询绩效出错：" + e.message) : (t.funds = e.funds, t.funds.reverse(), t.paintTrend()), t.loading.fund = !1 })
                    },
                    getTrdSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                    ...
                    getSigSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                            a = [];
                        return e.forEach(function(t, e) { e > 1 ? a[e] = "" : 0 != e ? 1 == e && (a[e] = s.length + "笔") : a[e] = "总计" }), a
                    },
                    getRndSum: function(t) {
                        var e = t.columns,
                            s = t.data,
                    ...
                    paintChart: function(t) {
                        var e = this.bars || [];
                        t = t || !1;
                        null == this.kChart && (this.kChart = this.$echarts.init(document.getElementById("bt_kline")));
                        var s = [],
                            a = [];
                        e.forEach(function(e, i) {
                            var n = e.date + "";
                            if (n = n.substr(0, 4) + "/" + parseInt(n.substr(4, 2)) + "/" + parseInt(n.substr(6, 2)), !t) {
                                var o = e.time % 1e4 + "";
                                3 == o.length && (o = "0" + o), n += " " + o.substr(0, 2) + ":" + o.substr(2, 2)
                            }
                            s.push(n), a.push([e.open, e.close, e.low, e.high])
                        });
                        var i = [],
                            n = [],
                            o = "";
                        JSON.parse(w()(this.trades)).reverse().forEach(function(t) {
                            var e = t.time + "";
                            e = e.substr(0, 4) + "/" + parseInt(e.substr(4, 2)) + "/" + parseInt(e.substr(6, 2)) + " " + e.substr(8, 2) + ":" + e.substr(10, 2);
                            var s = "开多" == t.action || "平空" == t.action || "OL" == t.action || "CS" == t.action,
                                a = "开" == t.action[0] || "O" == t.action[0];
                            if (o == e) {
                                var l = i[i.length - 1];
                                l.data.volume += t.volume, l.data.flag += a ? 1 : 2
                            } else i.push({ value: [e, t.price], symbol: "triangle", symbolRotate: s ? 0 : 180, symbolOffset: [0, s ? "50%" : "-50%"], itemStyle: { color: s ? "#f00" : "#0f0" }, data: { isBuy: s, volume: t.volume, price: t.price, flag: a ? 1 : 2 } });
                            var r = i[i.length - 1],
                                c = i[i.length - 2];
                            if (r.data.flag >= 2) {
                                var u = (r.data.price - c.data.price) * (s ? -1 : 1) >= 0;
                                n.push({ source: i.length - 2, target: i.length - 1, lineStyle: { color: u ? "#f00" : "#0f0", type: "solid", width: 1 } })
                            }
                            o = e
                        });
                        var l = {
                            title: { text: this.btInfo.state.code + " " + this.btInfo.state.period },
                            toolbox: { show: !0, orient: "horizontal", feature: { saveAsImage: {}, restore: {} } },
                            tooltip: {
                                trigger: "axis",
                                axisPointer: { type: "cross" },
                                formatter: function(t) {
                                    t.sort(function(t, e) { return t.seriesIndex - e.seriesIndex });
                                    var e, s = t[0].axisValue,
                                        a = t[0].data,
                                        i = s + "<br/><br/>";
                                    if (i += t[0].marker + "开: " + a[1].toFixed(2) + "<br/>", i += t[0].marker + "高: " + a[4].toFixed(2) + "<br/>", i += t[0].marker + "低: " + a[3].toFixed(2) + "<br/>", i += t[0].marker + "收: " + a[2].toFixed(2) + "<br/>", t.length > 1) {
                                        var n = t[1].data.data,
                                            o = (e = n).isBuy ? 3 == e.flag ? "翻多: +" : 2 == e.flag ? "平空: +" : "开多: +" : 3 == e.flag ? "翻空: -" : 2 == e.flag ? "平多: -" : "开空: -";
                                        i += t[1].marker + o + n.volume + "@" + n.price + "<br/>"
                                    }
                                    return i
                                }
                            },
                            ...
                            xAxis: { type: "category", data: s, scale: !0, boundaryGap: !0, axisLine: { onZero: !1 }, splitLine: { show: !1 }, splitNumber: 20, min: "dataMin", max: "dataMax" },
                            yAxis: { scale: !0, splitArea: { show: !0 } },
                            dataZoom: [{ type: "inside", start: 90, end: 100 }, { show: !0, type: "slider", y: "95%", start: 90, end: 100 }],
                            series: [{ name: "K线", type: "candlestick", data: a, yAxisIndex: "0", itemStyle: { normal: { color: "#ec0000", color0: "#00da3c", borderColor: "#8A0000", borderColor0: "#008F28" } }, markLine: { symbol: ["none", "none"], data: [{ name: "min line on close", type: "min", valueDim: "close" }, { name: "max line on close", type: "max", valueDim: "close" }] } }, { type: "graph", layout: "none", coordinateSystem: "cartesian2d", data: i, links: n, symbolSize: 20, zlevel: 9 }]
                        };
                        this.kChart.setOption(l)
                    },
                    fmtDate: function(t) { var e = t + ""; return e.substr(0, 4) + "." + e.substr(4, 2) + "." + e.substr(6, 2) },
                    fmtProfit: function(t) { return t > 0 ? "text-danger" : t < 0 ? "text-success" : "" },
                    fmtTime: function(t, e) { if (e = e || !1) { var s = t + ""; return s.substr(2, 2) + "." + s.substr(4, 2) + "." + s.substr(6, 2) + " " + s.substr(8, 2) + ":" + s.substr(10, 2) + ":" + s.substr(12, 2) + "," + s.substr(14, 3) } var a = t + ""; return a.substr(2, 2) + "." + a.substr(4, 2) + "." + a.substr(6, 2) + " " + a.substr(8, 2) + ":" + a.substr(10, 2) },
                    ...
                    paintTrend: function() {
                        ...
                        t.xAxis.data = e, t.series[0].data = s, t.yAxis[0].max = l, t.yAxis[0].min = r, this.tChart.setOption(t)
                    },
                    getClass: function(t) { return t >= 0 ? "text-danger" : "text-success" }
                },
                mounted: function() {
                    window.onresize = function() {
                        var t = this;
                        t.zooming || (t.zooming = !0, setTimeout(function() { t.kChart && t.kChart.resize(), t.tChart && t.tChart.resize(), t.zooming = !1 }, 300))
                    }
                }
            }),
            R = {
        ...
        var H = s("VU/8")(V, J, !1, function(t) { s("EKW2"), s("GSMS") }, "data-v-9281519c", null).exports,
            ...
            tt = {
                ...
                methods: {
                    ...
                    queryData: function() {
                        var t = this;
                        t.resetConf(), t.loading = !0, setTimeout(function() {
                            t.$api.getMonApps(function(e) {
                                if (e.result < 0) t.$message.error(e.message);
                                else {
                                    for (var s = [], a = X()(e.schedules), i = 0; i < a.length; i++) {
                                        var n = a[i],
                                            o = e.schedules[n];
                                        o.state = o.running ? "运行中" : "未启动", o.guardstr = o.guard ? "是" : "否", o.task = o.schedule.active ? "是" : "否", s.push(o)
                                    }
                                    t.monitors = s
                                }
                                t.loading = !1
                    ...
                    handleAppCommand: function(t) {
                        var e = this,
                            s = this;
                        "add" == t ? (this.resetConf(), this.addApp = !0) : "del" == t ? this.$confirm("确定要删除该调度任务吗?", "调度管理", { confirmButtonText: "确定", cancelButtonText: "取消", type: "warning" }).then(function() {
                            e.$api.delApp(s.curMonCfg.id, function(t) {
                                if (t.result < 0) s.$alert(t.message);
                                else
                                    for (var e = 0; e < s.monitors.length; e++)
                                        if (s.monitors[e].id == s.curMonCfg.id) { s.monitors.splice(e, 1), e; break }
                            })
                        }) : "refresh" == t ? this.queryData() : "start" == t ? this.$api.startApp(this.curMonCfg.id, function(t) {
                            if (t.result < 0) e.$message.error(t.message);
                            else
                                for (var s = 0; s < e.monitors.length; s++)
                                    if (e.monitors[s].id == e.curMonCfg.id) { e.monitors[s].state = "运行中", e.monitors[s].running = !0; break }
                        }) : "stop" == t && this.$api.stopApp(this.curMonCfg.id, function(t) {
                            if (t.result < 0) e.$message.error(t.message);
                            else
                                for (var s = 0; s < e.monitors.length; s++)
                                    if (e.monitors[s].id == e.curMonCfg.id) { e.monitors[s].state = "未启动", e.monitors[s].running = !1; break }
                        })
                    }
                },
                mounted: function() {
                    var t = this;
                    this.$nextTick(function() { t.queryData(), t.queryLogs() })
                }
            },
            et = {
                render: function() {
        ...
        Date.prototype.format = function(t) { var e = { "M+": this.getMonth() + 1, "d+": this.getDate(), "h+": this.getHours(), "m+": this.getMinutes(), "s+": this.getSeconds(), "q+": Math.floor((this.getMonth() + 3) / 3), S: this.getMilliseconds() }; for (var s in /(y+)/.test(t) && (t = t.replace(RegExp.$1, (this.getFullYear() + "").substr(4 - RegExp.$1.length))), e) new RegExp("(" + s + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? e[s] : ("00" + e[s]).substr(("" + e[s]).length))); return t }, Date.prototype.addDays = function(t) { var e = this.valueOf(); return new Date(e += 864e5 * t) }, String.prototype.format = function(t) {
            if (arguments.length > 0) {
                var e = this;
                if (1 == arguments.length && "object" == (void 0 === t ? "undefined" : wt()(t)))
                    for (var s in t) {
        ...
        a.default.prototype.$echarts = mt.a, a.default.config.productionTip = !1, a.default.use(ft.a), a.default.use(ut.a, ct.a);
        var xt = new function() {
            this.setItem = function(t, e) { return window.localStorage.setItem(t, e) }, this.getItem = function(t) { return window.localStorage.getItem(t) || "" }, this.token = this.getItem("token"), this.removeItem = function(t) { return window.localStorage.removeItem(t) }, this.checkBT = function(t) { a.default.axios.post("/hasbt", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.login = function(t, e, s) {
                var i = { loginid: t, passwd: bt()(e) };
                a.default.axios.post("/mgr/login", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.modpwd = function(t, e, s) {
                var i = { oldpwd: bt()(t), newpwd: bt()(e) };
                a.default.axios.post("/mgr/modpwd", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.resetpwd = function(t, e, s) {
                var i = { loginid: t, passwd: bt()(e) };
                a.default.axios.post("/mgr/resetpwd", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getGroups = function(t) { a.default.axios.post("/mgr/qrygrp", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.startGroup = function(t, e) {
                var s = { groupid: t || "" };
                a.default.axios.post("/mgr/startgrp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.stopGroup = function(t, e) {
                var s = { groupid: t || "" };
                a.default.axios.post("/mgr/stopgrp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.delGroup = function(t, e) {
                var s = { groupid: t || "" };
                a.default.axios.post("/mgr/delgrp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getFolders = function(t) { a.default.axios.post("/mgr/qrydir", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.commitGroup = function(t, e, s) {
                var i = JSON.parse(w()(t));
                i.groupid = t.id, i.action = e, a.default.axios.post("/mgr/addgrp", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getGroupDir = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qrygrpdir", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getGroupFile = function(t, e, s) {
                var i = { groupid: t, path: e };
                a.default.axios.post("/mgr/qrygrpfile", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.commitGroupFile = function(t, e, s, i) {
                var n = { groupid: t, path: e, content: s };
                a.default.axios.post("/mgr/cmtgrpfile", n).then(function(t) { 200 != t.status ? i({ result: -9999, message: textStatus }) : i(t.data) }, function(t) { i({ result: -9999, message: t.message }) })
            }, this.getLogs = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { id: t, type: e };
                a.default.axios.post("/mgr/qrylogs", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getMonCfg = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qrymon", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.commitMonCfg = function(t, e) {
                var s = t;
                a.default.axios.post("/mgr/cfgmon", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getStrategies = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, type: e };
                a.default.axios.post("/mgr/qrystras", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getChannels = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qrychnls", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getTrades = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, strategyid: e };
                a.default.axios.post("/mgr/qrytrds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getSignals = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, strategyid: e };
                a.default.axios.post("/mgr/qrysigs", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getRounds = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, strategyid: e };
                a.default.axios.post("/mgr/qryrnds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getPositions = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, strategyid: e };
                a.default.axios.post("/mgr/qrypos", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getFunds = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, strategyid: e };
                a.default.axios.post("/mgr/qryfunds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getChnlOrders = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, channelid: e };
                a.default.axios.post("/mgr/qrychnlords", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getChnlTrades = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, channelid: e };
                a.default.axios.post("/mgr/qrychnltrds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getChnlPositions = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, channelid: e };
                a.default.axios.post("/mgr/qrychnlpos", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getChnlFunds = function(t, e, s) {
                "function" == typeof e && (s = e, e = "");
                var i = { groupid: t, channelid: e };
                a.default.axios.post("/mgr/qrychnlfund", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getUsers = function(t) { a.default.axios.post("/mgr/qryusers", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.commitUser = function(t, e, s) {
                var i = ht()({}, t);
                i.action = e || "add", "********" != i.passwd && (i.passwd = bt()(i.passwd)), a.default.axios.post("/mgr/cmtuser", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.delUser = function(t, e) {
                var s = { loginid: t };
                a.default.axios.post("/mgr/deluser", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getActions = function(t, e, s) {
                var i = { sdate: t, edate: e };
                a.default.axios.post("/mgr/qryacts", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getPythonPath = function(t) { a.default.axios.post("/mgr/qryexec", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.getMonApps = function(t) { a.default.axios.post("/mgr/qrymons", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.startApp = function(t, e) {
                var s = { appid: t || "" };
                a.default.axios.post("/mgr/startapp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.stopApp = function(t, e) {
                var s = { appid: t || "" };
                a.default.axios.post("/mgr/stopapp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getMonLogs = function(t) { a.default.axios.post("/mgr/qrymonlog", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.delApp = function(t, e) {
                var s = { appid: t || "" };
                a.default.axios.post("/mgr/delapp", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortPositions = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryportpos", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortFunds = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryportfunds", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortTrades = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryporttrd", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortRounds = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryportrnd", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortPerfs = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryportperfs", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getPortFilters = function(t, e) {
                var s = { groupid: t };
                a.default.axios.post("/mgr/qryportfilters", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.commitPortFilters = function(t, e, s) {
                var i = { groupid: t, filters: e };
                a.default.axios.post("/mgr/cmtgrpfilters", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBtStrategies = function(t) { a.default.axios.post("/bt/qrystras", {}).then(function(e) { 200 != e.status ? t({ result: -9999, message: textStatus }) : t(e.data) }, function(e) { t({ result: -9999, message: e.message }) }) }, this.addBtStrategy = function(t, e) {
                var s = { name: t };
                a.default.axios.post("/bt/addstra", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.delBtStrategy = function(t, e) {
                var s = { straid: t };
                a.default.axios.post("/bt/delstra", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getBtStraCode = function(t, e) {
                var s = { straid: t };
                a.default.axios.post("/bt/qrycode", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.commitBtStraCode = function(t, e, s) {
                var i = { straid: t, content: e };
                a.default.axios.post("/bt/setcode", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBacktests = function(t, e) {
                var s = { straid: t };
                a.default.axios.post("/bt/qrystrabts", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.runBacktest = function(t, e, s, i, n, o) {
                "function" == typeof n && (o = n, n = 0);
                var l = { straid: t, stime: e, etime: s, capital: i, slippage: n };
                a.default.axios.post("/bt/runstrabt", l).then(function(t) { 200 != t.status ? o({ result: -9999, message: textStatus }) : o(t.data) }, function(t) { o({ result: -9999, message: t.message }) })
            }, this.delBacktest = function(t, e) {
                var s = { btid: t };
                a.default.axios.post("/bt/delstrabt", s).then(function(t) { 200 != t.status ? e({ result: -9999, message: textStatus }) : e(t.data) }, function(t) { e({ result: -9999, message: t.message }) })
            }, this.getBtSignals = function(t, e, s) {
                var i = { straid: t, btid: e };
                a.default.axios.post("/bt/qrybtsigs", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBtTrades = function(t, e, s) {
                var i = { straid: t, btid: e };
                a.default.axios.post("/bt/qrybttrds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBtRounds = function(t, e, s) {
                var i = { straid: t, btid: e };
                a.default.axios.post("/bt/qrybtrnds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBtFunds = function(t, e, s) {
                var i = { straid: t, btid: e };
                a.default.axios.post("/bt/qrybtfunds", i).then(function(t) { 200 != t.status ? s({ result: -9999, message: textStatus }) : s(t.data) }, function(t) { s({ result: -9999, message: t.message }) })
            }, this.getBtBars = function(t, e, s, i, n) {
                var o = { code: t, period: e, stime: s, etime: i };
                a.default.axios.post("/bt/qrybars", o).then(function(t) { 200 != t.status ? n({ result: -9999, message: textStatus }) : n(t.data) }, function(t) { n({ result: -9999, message: t.message }) })
            }
        };
        a.default.prototype.$api = xt, a.default.prototype.$pusher = new function() {
            ...
            }, this.send = function(t, e) { this.socket && this.socket.send(w()(e)) }, this.init = function(t, e) {
                var s = this;
        ...
        }, new a.default({ store: lt, el: "#app", router: ot, components: { App: o }, template: "<App/>" })
    },
    Unev: function(t, e, s) { t.exports = s.p + "static/img/login_logo.06057c1.svg" },
    Yklg: function(t, e) {},
    Yokd: function(t, e) {},
    cNKU: function(t, e) {},
    duJY: function(t, e) {},
