from ztpy.wrapper import ZtWrapper
...
from ztpy.ExtToolDefs import BaseIndexWriter, BaseDataReporter
from ztpy.ZtCoreDefs import EngineType
from ztpy.ExtModuleDefs import BaseExtParser, BaseExtExecuter, BaseExtDataLoader
...
class ZtEngine:
    ...
    def __init__(self, eType:EngineType, logCfg:str = "logcfg.yaml", genDir:str = "generated", bDumpCfg:bool = False):
        ...
        self.__wrapper__:ZtWrapper = ZtWrapper(self)  #api接口转换器
