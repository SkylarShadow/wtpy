...
class BaseExtDataLoader:
    ...
    def load_final_his_bars(self, stdCode:str, period:str, feeder) -> bool:
        ...
        @period     周期，m1/m5/d1
        @feeder     回调函数，feed_raw_bars(bars:POINTER(ZTSBarStruct), count:int)
        '''
        return False
    ...
    def load_his_ticks(self, stdCode:str, uDate:int, feeder) -> bool:
        ...
        @feeder     回调函数，feed_raw_bars(bars:POINTER(ZTSTickStruct), count:int)
        '''
        return False
