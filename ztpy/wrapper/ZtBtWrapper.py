...
from ztpy.ZtCoreDefs import CB_HFTSTRA_CHNL_EVT, CB_HFTSTRA_ENTRUST, CB_HFTSTRA_ORD, CB_HFTSTRA_TRD, CB_SESSION_EVENT
...
from ztpy.ZtCoreDefs import EVENT_ENGINE_INIT, EVENT_SESSION_BEGIN, EVENT_SESSION_END, EVENT_ENGINE_SCHDL, EVENT_BACKTEST_END
...
class ZtBtWrapper:
    ...
    def __init__(self, engine):
        ...
        dllname = ph.getModule("ZtBtPorter")
        a = (paths[:-1] + (dllname,))
    ...
    def on_hftstra_get_transaction(self, id:int, stdCode:str, newTrans:POINTER(ZTSTransStruct), count:int, isLast:bool):
        engine = self._engine
        ctx = engine.get_context(id)
