from ztpy.wrapper.ZtMQWrapper import ZtMQWrapper, CB_ON_MSG
...
class ZtMQServer:
    ...
    def init(self, wrapper:ZtMQWrapper, id:int):
        self.id = id
...
class ZtMsgQue:
    ...
    def __init__(self) -> None:
        self._servers = dict()
        self._clients = dict()
        self._wrapper = ZtMQWrapper(self)

        self._cb_msg = CB_ON_MSG(self.on_mq_message)

    def get_client(self, client_id:int) -> ZtMQClient:
    ...
    def add_mq_server(self, url:str, server:ZtMQServer = None) -> ZtMQServer:
    ...
    def destroy_mq_server(self, server:ZtMQServer):
        id = server.id
    ...
    def add_mq_client(self, url:str, client:ZtMQClient = None) -> ZtMQClient:
    ...
    def destroy_mq_client(self, client:ZtMQClient):
        id = client.id
