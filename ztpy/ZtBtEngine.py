from ztpy.wrapper import ZtBtWrapper
from ztpy.CtaContext import CtaContext
from ztpy.SelContext import SelContext
from ztpy.HftContext import HftContext
from ztpy.StrategyDefs import BaseCtaStrategy, BaseSelStrategy, BaseHftStrategy
from ztpy.ExtToolDefs import BaseIndexWriter
from ztpy.ZtCoreDefs import EngineType
from ztpy.ZtUtilDefs import singleton
from ztpy.ExtModuleDefs import BaseExtDataLoader

from ztpy.ProductMgr import ProductMgr, ProductInfo
from ztpy.SessionMgr import SessionMgr, SessionInfo
from ztpy.ContractMgr import ContractMgr, ContractInfo

from ztpy.CodeHelper import CodeHelper
...
class ZtBtEngine:
    ...
    def __init__(self, eType:EngineType = EngineType.ET_CTA, logCfg:str = "logcfgbt.yaml", isFile:bool = True, bDumpCfg:bool = False, outDir:str = "./outputs_bt"):
        ...
        self.__wrapper__ = ZtBtWrapper(self)  #api接口转换器
